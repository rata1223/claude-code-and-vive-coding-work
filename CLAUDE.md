...
## 프로젝트 진행 현황 (2026-09-22 기준, main `5ed42b3` = PR #165)
...
- **현재 열린 PR 0건.** main = `5ed42b3` (PR #165)
...
5. 열린 이슈:
   - **#161** `StartupRecovery`의 브로커 조회가 타임아웃 뒤에도 블록 — 기동 중 SIGTERM이
     SIGKILL까지 가는 주원인. **작업 중**
   ...
   - ~~#160~~ 완료(PR #165) · ~~#158~~ 완료(PR #163) · ~~#167~~ 완료(PR #165)
